...
import "/js/modal/admin.js?version=2025121501";
...
const FH = {
    ...
    virtualNum: 0,
    getList: function () {
        _this.methods.doGetActiveHistoryList();
    },
    events: {
        /**
         * key 이벤트
    ...
    methods: {
        ...
        /**
         * 관리자 활동 기록 리스트 - 데이터 조회
         * @returns {Promise<void>}
         */
        doGetActiveHistoryList: async function (type = 1) {
            ...
            if (type === -1) {
                ...
                params.limit = -1;
                DOWNLOAD_MODAL.methods.download('/api/admin/etc/doGetActiveHistoryList', params);
                return;
            }
            ...
            // console.log(params);
            const res = await ServiceExec.post('/api/admin/etc/doGetActiveHistoryList', params);
            const code = res.code;
