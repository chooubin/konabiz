...
$(function(){
    ...
    // 사이드 메뉴 영역 숨김 기능
    $('aside .btn-flip').click(function(){
        $(this).parent().toggleClass('active');
    });

    // 헤더 검색, 선택 클릭 기능
    // $('.admin .header .left .top-search .box > a').click(function(){
    //     $(this).parent().addClass('active').siblings().removeClass('active');
    //     return false;
    // })

    // 테이블 상단 검색 기능(펼침)
    // $('.h2-head .btn-srch').click(function(){
    //     $(this).closest('.h2-head').addClass('srch-on');
    //     $(this).closest('.h2-head').siblings('.board-srch').slideDown(300);
    //
    // })
    // $('.h2-head .btn-srch-close').click(function(){
